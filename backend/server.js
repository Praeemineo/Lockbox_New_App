    ...
    try {
        ...
        try {
            ...
            if (['XLSX', 'XLS', 'CSV', 'TSV'].includes(fileType)) {
                ...
                // PDF files - Use OCR/LLM for intelligent extraction
                ...
                try {
                    ...
                    if (extractedData.rows && extractedData.rows.length > 0) {
                        ...
                        run.ocrProvider = ocrResult.provider;
                        run.ocrModel = ocrResult.model;
                    }
                    
                    console.log('PDF OCR extraction successful - Rows:', jsonData.length);
