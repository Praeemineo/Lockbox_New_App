...
INSERT INTO lb_processing_rules (
    ...
    10,
    'S4HANA_SYSTEM_DESTINATION',
    $$[{"documentFormat": "Customer Number","condition": "Exist"}]$$::jsonb,
    $$[{"httpMethod": "GET","apiReference": "/sap/opu/odata/sap/API_BUSINESS_PARTNER/A_BusinessPartner(BusinessPartner='')?$expand=to_BusinessPartnerBank&$format=json","destination": "S4HANA_SYSTEM_DESTINATION","inputField": "BusinessPartner","sourceInput": "CustomerNumber","outputField": "to_BusinessPartnerBank/results/0/BankNumber","lockboxApiField": "PartnerBank"},{"httpMethod": "GET","apiReference": "/sap/opu/odata/sap/API_BUSINESS_PARTNER/A_BusinessPartner(BusinessPartner='')?$expand=to_BusinessPartnerBank&$format=json","destination": "S4HANA_SYSTEM_DESTINATION","inputField": "BusinessPartner","sourceInput": "CustomerNumber","outputField": "to_BusinessPartnerBank/results/0/BankAccount","lockboxApiField": "PartnerBankAccount"},{"httpMethod": "GET","apiReference": "/sap/opu/odata/sap/API_BUSINESS_PARTNER/A_BusinessPartner(BusinessPartner='')?$expand=to_BusinessPartnerBank&$format=json","destination": "S4HANA_SYSTEM_DESTINATION","inputField": "BusinessPartner","sourceInput": "CustomerNumber","outputField": "to_BusinessPartnerBank/results/0/BankCountryKey","lockboxApiField": "PartnerBankCountry"}]$$::jsonb,
    '2026-02-16T12:00:00Z'::timestamp,
...
INSERT INTO lb_processing_rules (
    ...
    10,
    'S4HANA_SYSTEM_DESTINATION',
    $$[{"documentFormat": "Status","condition": "Simulated"}]$$::jsonb,
    $$[{"httpMethod": "POST","apiReference": "/sap/opu/odata/sap/API_LOCKBOXPOST_IN/LockboxBatch","destination": "S4HANA_SYSTEM_DESTINATION","inputField": "SAP Payload","sourceInput": "SAP Payload","outputField": "","lockboxApiField": ""},{"httpMethod": "GET","apiReference": "/sap/opu/odata/sap/API_LOCKBOXPOST_IN/LockboxClearing","destination": "S4HANA_SYSTEM_DESTINATION","inputField": "Lockbox Batch","sourceInput": "Payment Advice","outputField": "Accounting document","lockboxApiField": "Subledgerdocument"}]$$::jsonb,
    '2026-02-16T12:00:00Z'::timestamp,
...
SELECT rule_id, rule_name, rule_type, active, jsonb_array_length(api_mappings) as api_mapping_count, jsonb_array_length(conditions) as condition_count, updated_at FROM lb_processing_rules ORDER BY rule_id;
